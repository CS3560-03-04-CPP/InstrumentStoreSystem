...
CREATE TABLE `item_store_records` (
  ...
  PRIMARY KEY (`itemID`,`store_records_id`),
  ...
  CONSTRAINT `fk_item_store_records_item` FOREIGN KEY (`itemID`) REFERENCES `item` (`itemID`) ON DELETE CASCADE ON UPDATE CASCADE
